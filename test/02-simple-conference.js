...
const Conference = artifacts.require('SimpleConference')
...
contract('Simple Conference behavior', accounts => {
  const [
    owner,
    assistant
  ] = accounts
  ...
  it('should get a balance equal to 1 for the BSL contract after closing the conference', async() => {
